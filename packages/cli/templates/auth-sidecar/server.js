    ...
    if (!cachedToken) {
      ...
      try {
        ...
        if (!dbSuccess) {
          ...
          console.warn("    You may need to manually add the token to the database");
        }
      } catch (err) {
        console.error(
...
const server = http.createServer(async (req, res) => {
  ...
  // Token info endpoint (only accessible from localhost and only for auto-generated tokens)
  if (req.url === "/token-info") {
    ...
    res.end(JSON.stringify({
      isAutoGenerated,
      token: cachedToken,
      message: "Token was auto-generated. Please save it securely and configure it in your deployment."
    }));
    return;
  }
